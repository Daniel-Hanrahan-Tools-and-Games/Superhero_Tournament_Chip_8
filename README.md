...
<a href="https://github.com/Daniel-Hanrahan-Tools-and-Games/Superhero_Tournament_Chip_8">Repository Page</a>


Info on screen:
player info to left, opponent info to right, with info T = Tool, W = Wizard, S = Super, G = Gamer.

Controls (Chip-8 Keypad):
A = attack/confirm
0 = power up, when that happens power gets incremented by 5.

After a side hits 0 health, W = Win, L = Lose.

Advantages:
Tool > Wizard > Super > Tool: 10 damage at start
Neutral / Gamer Type: 7 damage at start.
